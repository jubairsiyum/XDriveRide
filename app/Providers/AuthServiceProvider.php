...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
       ...
       // Passport::routes();
        ...
        Gate::define('subscription_view', fn () => $this->checkAccess('subscription_management', 'view'));
        Gate::define('subscription_add', fn () => $this->checkAccess('subscription_management', 'add'));
        Gate::define('subscription_edit', fn () => $this->checkAccess('subscription_management', 'update'));
        Gate::define('subscription_delete', fn () => $this->checkAccess('subscription_management', 'delete'));
