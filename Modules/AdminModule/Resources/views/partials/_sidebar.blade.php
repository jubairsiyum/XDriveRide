    ...
    <div class="position-relative flex-grow-1">
        <div class="aside-body" data-trigger="scrollbar">
            ...
            <ul class="main-nav nav">
                ...
                @if(\Illuminate\Support\Facades\Gate::any(['subscription_view', 'subscription_add', 'subscription_edit', 'subscription_delete']))
                    <!---------- Start Subscription Management --------------->
                    <li class="nav-category" title="{{ translate('subscription_management') }}">{{ translate('subscription_management') }}</li>
                    <li class="{{request()->routeIs('admin.subscriptions.dashboard') ? 'active open' : ''}}">
                        <a href="{{route('admin.subscriptions.dashboard')}}">
                            <i class="bi bi-graph-up"></i>
                            <span class="link-title text-capitalize">{{ translate('dashboard') }}</span>
                        </a>
                    </li>
                    <li class="has-sub-item {{Request::is('admin/subscriptions/plans*') ? 'active sub-menu-opened' : ''}}">
                        <a href="#">
                            <i class="bi bi-card-list"></i>
                            <span class="link-title text-capitalize">{{ translate('Plans Management') }}</span>
                        </a>
                        <!-- Sub Menu -->
                        <ul class="nav flex-column sub-menu text-capitalize">
                            <li class="{{Request::is('admin/subscriptions/plans') || Request::is('admin/subscriptions/plans/edit*') || Request::is('admin/subscriptions/plans/show*') ? 'active open' : ''}}">
                                <a href="{{ route('admin.subscriptions.plans.index') }}">
                                    <i class="bi bi-dash-lg"></i>
                                    {{ translate('All Plans') }}
                                </a>
                            </li>
                            <li class="{{Request::is('admin/subscriptions/plans/create') ? 'active open' : ''}}">
                    ...
                    <li class="has-sub-item {{Request::is('admin/subscriptions/list*') ? 'active sub-menu-opened' : ''}}">
                        <a href="#">
                            <i class="bi bi-people-fill"></i>
                            <span class="link-title text-capitalize">{{ translate('Subscriptions') }}</span>
                        </a>
                        <!-- Sub Menu -->
                        <ul class="nav flex-column sub-menu text-capitalize">
                            <li class="{{Request::is('admin/subscriptions/list') || Request::is('admin/subscriptions/list/*') ? 'active open' : ''}}">
                                <a href="{{ route('admin.subscriptions.subscriptions.index') }}">
                                    <i class="bi bi-dash-lg"></i>
                    ...
                    <li class="has-sub-item  {{Request::is('admin/business/configuration*')? 'active sub-menu-opened' : ''}}">
                        ...
                        <ul class="nav sub-menu">
                            ...
                            <li class="{{Request::is('admin/business/configuration/login-settings*') ? 'active open' : ''}}">
                                <a href="{{ route('admin.business.configuration.login-settings.index') }}"
                                   class="text-capitalize">
                                    <i class="bi bi-dash-lg"></i>
