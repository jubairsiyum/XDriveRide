...
class CreateTripRequestCoordinatesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('trip_request_coordinates', function (Blueprint $table) {
            ...
            $table->json('driver_accept_coordinates')->nullable();
            $table->json('customer_request_coordinates')->nullable();
            $table->timestamps();
        });
    }
