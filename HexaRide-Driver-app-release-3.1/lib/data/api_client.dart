...
class ApiClient extends GetxService {
  ...
  static final String invalidBaseUrlMessage =
      'Base URL is not configured. Set AppConstants.baseUrl or pass --dart-define=BASE_URL=...';
  ...
  bool get _hasValidBaseUrl {
    final String trimmed = appBaseUrl.trim();
    return trimmed.isNotEmpty && !trimmed.contains('YOUR_BASE_URL_HERE');
  }

  Response _invalidBaseUrlResponse() {
    return Response(statusCode: 0, statusText: invalidBaseUrlMessage);
  }
  ...
  Future<Response> getData(String uri, {Map<String, dynamic>? query, Map<String, String>? headers}) async {
    if(!_hasValidBaseUrl) {
      return _invalidBaseUrlResponse();
    }
    try {
      if(kDebugMode) {
        log('====> API Call: $uri\nHeader: $_mainHeaders');
